...
/**
 * Flags to be returned from {@link AppWidget#getFlags(int)}.
 * 
...
public class StandOutFlags {
	 ...
	 * {@link AppWidget#getHiddenIcon(int)},
	 * {@link AppWidget#getHiddenTitle(int)}, and
	 * {@link AppWidget#getHiddenMessage(int)} are implemented, and that
	 ...
	 * {@link AppWidget#onTouchHandleResize(int, Window, View, MotionEvent)}
	 * . The aspect ratio will not be enforced if you set the width or height of
	 * the window's LayoutParams manually.
	 * 
	 * @see AppWidget#onTouchHandleResize(int, Window, View, MotionEvent)
	 */
	 ...
	 * keys.
	 * 
	 * @see {@link AppWidget#focus(int)}
	 * @see {@link AppWidget#unfocus(int)}
	 * 
	 */
	 ...
	 * {@link AppWidget#onFocusChange(int, Window, boolean)}.
	 * 
	 ...
	 * implementation.
	 * 
	 * @see {@link AppWidget#addFunctionality(View, int)}
	 */
